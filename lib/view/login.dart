...
class _LoginScreenState extends State<LoginScreen> {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      ...
                      colors: [
                        Color.fromRGBO(46, 49, 146, 1).withOpacity(0.7),
                        Color.fromRGBO(27, 255, 255, 1).withOpacity(0.3),
                      ],
                    ),
                    boxShadow: [
                      BoxShadow(
                        ...
                        Row(
                          children: [
                            ...
                            Checkbox(
                              ...
                              activeColor: Color.fromRGBO(27, 255, 255, 1),
                            ),
                          ],
                        ),
                        SizedBox(
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (content) => ForgotPasswordScreen()));
  ...
  void login() {
    ...
    if (!(emailCheck && passCheck)) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            "Please ensure both email and password in correct format and not empty!"),
        backgroundColor: Colors.red,
      ));
      return;
    }
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == "success") {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (content) => HomePageScreen()));
        } else {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
